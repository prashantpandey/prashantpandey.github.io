...
We built Gallatin {% cite DBLP:conf/ppopp/McCoyP24 %}, a general-purpose GPU memory manager, and WarpSpeed {% cite alenex25 %}, a high-performance library of concurrent GPU hash tables. On top of these we have designed high-performance filters for GPUs {% cite DBLP:conf/ppopp/McCoyHY023 %}, distributed-memory $k$-mer counting on GPUs {% cite DBLP:conf/ipps/NisaPEOBY21 %}, and updatable approximate nearest-neighbor search on GPUs {% cite arxiv26_jasper %}.
